...
########################################################################
#
# $Header: /opt/cvs/python/packages/share1.5/mglutil/gui/BasicWidgets/Tk/trees/tree.py,v 1.57 2012/10/09 23:24:12 sanner Exp $
#
# $Id: tree.py,v 1.57 2012/10/09 23:24:12 sanner Exp $
#
...
class Tree(ScrolledCanvas, KeySelectable, EventHandler):
    ...
    def __init__(self, master, root, iconsManager=None, selectionMode='single',
                 idleRedraw=True, nodeHeight=15, headerHeight=0, **kw):
...
below self"""
    ...
    def drawNodeLabel(self, x, y):
        ...
        if balloon:
            balloon.tagbind(canvas, labelTkid, origtext)
