...
# $Author: sanner $
# $Header: /opt/cvs/python/packages/share1.5/mglutil/splashregister/register.py,v 1.25.2.1 2013/03/21 23:59:50 sanner Exp $
# $Date: 2013/03/21 23:59:50 $
# $Id: register.py,v 1.25.2.1 2013/03/21 23:59:50 sanner Exp $
