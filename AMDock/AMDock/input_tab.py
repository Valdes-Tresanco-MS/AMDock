...
class Program_body(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        self.project_box_layout.addWidget(self.project_label, 1, 0)
        self.project_box_layout.addWidget(self.project_text, 1, 1, 1, 1)
        self.project_box_layout.addWidget(self.project_help, 0, 2)
        self.project_box_layout.addWidget(self.wdir_button, 2, 0)
        self.project_box_layout.addWidget(self.wdir_text, 2, 1, 1, 1)
        ...
        self.input_layout.addWidget(self.protein_text, 0, 1, 1, 1)
        self.input_layout.addWidget(self.protein_label, 1, 1, 1, 1)
        ...
        self.progressbar_layout.addWidget(self.indic_label)
        self.progressbar_layout.addWidget(self.progressBar)
        self.progressbar_layout.addWidget(self.reset_button)
