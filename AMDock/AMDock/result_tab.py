...
class Results(QtGui.QWidget):
    ...
    def show_best(self,b):
        if b.objectName() == 'best_button':
            if self.parent.v.docking_program == 'AutoDock Vina':
                visual_arg = [os.path.join(self.parent.v.result_dir, 'best_pose_target_ADV_result.pdb'), self.parent.ws.lig_site_pymol]
            else:
                visual_arg = [os.path.join(self.parent.v.result_dir, 'best_pose_target_AD4_result.pdb'), self.parent.ws.lig_site_pymol]
            ...
            if self.parent.v.docking_program == 'AutoDock Vina':
                visual_arg = [os.path.join(self.parent.v.result_dir, 'best_pose_off-target_ADV_result.pdb'),self.parent.ws.lig_site_pymol]
            else:
                visual_arg = [os.path.join(self.parent.v.result_dir, 'best_pose_off-target_AD4_result.pdb'),self.parent.ws.lig_site_pymol]
    ...
    def show_all(self,b):
        if b.objectName() == 'all_button':
            if self.parent.v.docking_program == 'AutoDock Vina':
                visual_arg=[os.path.join(self.parent.v.input_dir,self.parent.v.protein_pdbqt),os.path.join(self.parent.v.result_dir,'all_poses_target_ADV_result.pdb'),
                            self.parent.ws.protein_cartoon_pymol]
            else:
                visual_arg = [os.path.join(self.parent.v.input_dir,self.parent.v.protein_pdbqt),os.path.join(self.parent.v.result_dir, 'all_poses_target_AD4_result.pdb'),
                              self.parent.ws.protein_cartoon_pymol]
            ...
            if self.parent.v.docking_program == 'AutoDock Vina':
                visual_arg = [os.path.join(self.parent.v.input_dir,self.parent.v.analog_protein_pdbqt),os.path.join(self.parent.v.result_dir, 'all_poses_off-target_ADV_result.pdb'),self.parent.ws.protein_cartoon_pymol]
            else:
                visual_arg = [os.path.join(self.parent.v.input_dir,self.parent.v.analog_protein_pdbqt),os.path.join(self.parent.v.result_dir, 'all_poses_off-target_AD4_result.pdb'),self.parent.ws.protein_cartoon_pymol]
    ...
    def _show_complex(self):
        visual_arg = [ os.path.join(self.parent.v.input_dir,self.parent.v.protein_pdbqt),os.path.join(self.parent.v.input_dir,self.parent.v.ligand_pdbqt),self.parent.ws.protein_cartoon_pymol]
