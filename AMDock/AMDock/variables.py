...
class Text_and_ToolTip():
    ...
    input_tt = '<html><head/><body style="color: blue; font-family:Times New Roman; font-size:10pt;"><p><span ' \
               ...
               'text-decoration: underline;">Set pH</span><span >: Protonation states of protein residues and that of the ligand will be defined based on this pH value.</span></p><p><span style=" font-style:italic; text-decoration: underline;">Simple Docking</span><span >: Perform a simple molecular docking simulation. </span></p><p><span style="font-style:italic; text-decoration: underline;">Off-Target Docking(OD)</span><span >: Perform assays of selectivity between two proteins and a ligand.</span></p><p><span style="font-style:italic; text-decoration: underline;">Scoring</span><span >: Estimate the affinity of a complex using the scoring function of the selected program.</span></p><p><span style="font-style:italic; text-decoration: underline;">Protein (Target)</span><span >: Enter the protein (target) file.</span></p><p><span style="font-style:italic; text-decoration: underline;">Ligand</span><span >: Enter the ligand file.</span></p><p><span style="font-style:italic; text-decoration: underline;">Off-Targe(if OD is selected)</span><span>: Enter the protein (Off-Target) file. The Target will be considered as reference.</span></p></body></html>'
