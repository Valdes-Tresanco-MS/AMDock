...
class Text_and_ToolTip():
    prog_title = '<html><head/><body style="font-family:times;color:#000000;text-decoration: underline;"><p><span ' \
                 'style="font-size:24pt; font-weight:600;">AMDock</span><span style="font-size:16pt;font-weight:500">  ' \
                 'Assisted Molecular Docking with AutoDock4 and AutoDock Vina</span></p></body></html>'

    project_tt = '<html><head/><body style="font-family: Times New Roman; font-size:10pt; color: blue;"><p><span ' \
                 'style="font-weight:600;">Defining the working directory. </span></p><p><span style=" font-style:italic; text-decoration: underline;">Project Name</span><span >: Define the project´s name. By default, the project will be named as &quot;Docking_Project&quot;; If a folder with the same name already exists, the new folder will be renamed as: previous name + modification date.</span></p><p align="justify"><span style="font-style:italic; text-decoration: underline;">Location for Project</span><span>: Define the project´s location. </span><span style=" text-decoration: underline; color:#ff0000;">This parameter is mandatory!!!</span></p></body></html>'
    input_tt = '<html><head/><body style="color: blue; font-family:Times New Roman; font-size:10pt;"><p><span ' \
               'style="font-weight:600;">Defining the input files. </span></p><p><span style="font-style:italic; ' \
               'text-decoration: underline;">Set pH</span><span >: Protonation states of protein residues and that of the ligand will be defined based on this pH value.</span></p><p><span style=" font-style:italic; text-decoration: underline;">Simple Docking</span><span >: Perform a simple molecular docking simulation. </span></p><p><span style="font-style:italic; text-decoration: underline;">Off-Target Docking(OD)</span><span >: Perform assays of selectivity between two proteins and a ligand.</span></p><p><span style="font-style:italic; text-decoration: underline;">Scoring</span><span >: Estimate the affinity of a complex using the scoring function of the selected program.</span></p><p><span style="font-style:italic; text-decoration: underline;">Protein (Target)</span><span >: Enter the protein (target) file.</span></p><p><span style="font-style:italic; text-decoration: underline;">Ligand</span><span >: Enter the ligand file.</span></p><p><span style="font-style:italic; text-decoration: underline;">Off-Target(if OD is selected)</span><span>: Enter the protein (Off-Target) file. The Target will be considered as reference.</span></p></body></html>'
    grid_tt = '<html><head/><body style="color: blue; font-family:Times New Roman; font-size:10pt;"><p><span ' \
              'style="font-weight:600;">Defining the search space. </span></p><p><span style="font-style:italic;">The determination of the search space will be as follows:</span></p><p><span style="font-style:italic; text-decoration: underline;">Automatic: </span><span>A potential ligand binding site will be identified and characterized by using AutoLigand tool (see manual).<br/></span><span style="font-style:italic; text-decoration: underline;">Center on Residue(s)</span><span >: A box with optimal dimensions (see manual) will be placed on the geometric center of this/these residue(s)<br/></span><span style="font-style:italic; text-decoration: underline;">Center on Ligand</span><span > : A box with optimal dimensions (see manual) will be placed on the geometric center of ligand.<br/></span><span style="font-style:italic; text-decoration: underline;">Box</span><span >: Set the coordinates and dimensions respectively.</span></p></body></html>'
    result_tt = '<html><head/><body style="color: blue; font-family:Times New Roman; font-size:10pt;"><p><span ' \
                'style="font-weight:600;">Loading previous projects. </span></p><p><span style="font-style:italic; text-decoration: underline;">Load Data: </span><span>Open a dialog box that allows the selection of the .amdock file.<br/></span><span style="font-style:italic; text-decoration: underline;">Result File</span><span >: Open a dialog box that allows the visualization of the content of the .amdock file.<br/></span></p></body></html>'
