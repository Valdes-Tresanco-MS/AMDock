...
#
#
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/MoleculePreparation.py,v 1.89 2012/11/06 20:44:45 rhuey Exp $ 
#
#
#
import os, string
        ...
        if torsOnly:
            ...
            for new_try in range(ntries):
                ...
                for a in m.allAtoms:
                    if orig_d[a] != new_d[a]:
                        ok = False
                        if verbose: print "bonds differ for %s: %d v %d" % (
