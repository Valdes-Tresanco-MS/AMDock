...
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/DockingParameters.py,v 1.106 2013/01/16 16:14:34 rhuey Exp $
#
#
# $Id: DockingParameters.py,v 1.106 2013/01/16 16:14:34 rhuey Exp $
#
#
#
...
class DockingParameters(UserDict.UserDict):
    ...
    def _make_string(self, p, val_str):
        ...
        if (len(p['keyword']) + len(val_str))< 36:
            new_str = "%s %s%s# %s\n" % (p['keyword'],
                                  val_str,
